(function () {
    ...
    Slider.prototype.setActivePlaceholder = function () {
        var placeholders = document.querySelectorAll('.cartao-placeholder__item');
        var activePlaceholder = document.querySelector('.cartao-placeholder__item--active')

        if (activePlaceholder) {
        activePlaceholder.classList.remove('cartao-placeholder__item--active');
        }

        placeholders[this.currentIndex].classList.add('cartao-placeholder__item--active');
    ...
    Slider.prototype.resetCardElsPosition = function () {
        ...
        var cardLogo = card.querySelector('.cartao__logo');
        var cardPrice = card.querySelector('.cartao__price');
        var cardTitle = card.querySelector('.cartao__title');
        var cardSubtitle = card.querySelector('.cartao__subtitle');
        var cardImage = card.querySelector('.cartao__image');
        var cardWishList = card.querySelector('.cartao__wish-list');
        var cardCategory = card.querySelector('.cartao__category');
        var cardWillAnimate = card.querySelectorAll('.cartao__will-animate');
